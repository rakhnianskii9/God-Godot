...
**Agent delegation (MANDATORY)**: Before drafting Section C, spawn specialist agents as subagents in parallel:
...
**Agent delegation (MANDATORY)**: Before proposing any formulas or balance values, spawn specialist agents as subagents in parallel:
...
Before finalizing the GDD, spawn `creative-director` as a subagent using gate **CD-GDD-ALIGN**.
