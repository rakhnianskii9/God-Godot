...
| DRAG_STARTUP_TIME              | 0.2           | Seconds from the first native drag event to the first [single finger drag](#supported-gestures) custom event                                                                                                                                                                           |
...
| MULTI_FINGER_RELEASE_THRESHOLD | 0.1           | All fingers must be released within `MULTI_FINGER_REALEASE_THRESHOLD` seconds before the gesture ends for the [multiple finger tap](#supported-gestures) and [multiple finger swipe](#supported-gestures) gestures to be recognized                                                  |
...
| LONG_PRESS_TIME_THRESHOLD      | 0.75          | The fingers must press for `LONG_PRESS_TIME_THRESHOLD` seconds for [single-finger long press](#supported-gestures) and [multi-finger long press](#supported-gestures) gestures to be recognized.                                                                                     |
